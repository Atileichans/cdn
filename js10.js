...
function AlteraRele2(){
    ...
    if(estado_2 === "0"){
		...
		document.getElementById("botao_2").innerHTML="<a href='/?2_desligar' class='botao_2'>Pulso</a>";
    } else {
        document.getElementById("estado_2").innerHTML="0";
        document.getElementById("rele_2").innerHTML="<div class='rele2_desligado'></div>";
        document.getElementById("botao_2").innerHTML="<a href='/?2_ligar' class='botao_2'>Pulso</a>";
    }
}
 function AlteraRele3(){
    ...
    if(estado_3 === "0"){
		...
		document.getElementById("botao_3").innerHTML="<a href='/?3_desligar' class='botao_3'>Desligado</a>";
    } else {
        document.getElementById("estado_3").innerHTML="0";
        document.getElementById("rele_3").innerHTML="<div class='rele3_desligado'></div>";
        document.getElementById("botao_3").innerHTML="<a href='/?3_ligar' class='botao_3'>Ligado</a>";
    }
}
...
function AlteraRele4(){
    ...
    if(estado_4 === "0"){
		...
		document.getElementById("botao_4").innerHTML="<a href='/?4_desligar' class='botao_4'>Desligado</a>";
    } else {
        document.getElementById("estado_4").innerHTML="0";
        document.getElementById("rele_4").innerHTML="<div class='rele4_desligado'></div>";
        document.getElementById("botao_4").innerHTML="<a href='/?4_ligar' class='botao_4'>Ligado</a>";
    }
}
